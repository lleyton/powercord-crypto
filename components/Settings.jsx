...
var data = fs.readFileSync(
  path.resolve(__dirname, "../data/crypto.json"),
  "utf8"
);
...
module.exports = AsyncComponent.from(
  (async () => {
    const { getCurrentUser } = await getModule(["getCurrentUser"], true);
    const nitro = getCurrentUser.premiumType == 2;
            ...
            <div>
              <SwitchItem
                ...
                onChange={() => {
                  ...
                  if (!nitro) {
                    this.props.updateSetting("longChart", false);
                  }
                }}
              >
                Public messages
              ...
              <SliderInput
                ...
                onValueChange={(val) =>
                  this.props.updateSetting("defaultTimescale", Math.round(val))
                }
